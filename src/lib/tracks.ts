...
export const TRACKS: Record<MoodId, Track[]> = {
  festif: [
    ...
    { id: "f5", title: "Blinding Lights", artist: "The Weeknd", durationSec: 200, videoId: "4NRXx6pxkhM" },
    { id: "f6", title: "A Sky Full of Stars", artist: "Coldplay", durationSec: 268, videoId: "H5v3kku4y6Q" },
  ...
  romantique: [
    { id: "r1", title: "All of Me", artist: "John Legend", durationSec: 269, videoId: "450p7goxZqg" },
    { id: "r2", title: "Perfect", artist: "Ed Sheeran", durationSec: 263, videoId: "2Vv-BfVoq4g" },
    { id: "r3", title: "Don't Know Why", artist: "Norah Jones", durationSec: 187, videoId: "tO4dxvguQDk" },
    { id: "r4", title: "Better Together", artist: "Jack Johnson", durationSec: 207, videoId: "u57d4_b_YgI" },
    { id: "r5", title: "Stay With Me", artist: "Sam Smith", durationSec: 172, videoId: "pB-5XG-DbAA" },
    { id: "r6", title: "Put Your Records On", artist: "Corinne Bailey Rae", durationSec: 226, videoId: "Y8TrdM3S2Ds" },
    { id: "r7", title: "Careless Whisper", artist: "George Michael", durationSec: 300, videoId: "izGwDsrQ1eQ" },
    { id: "r8", title: "La Vie en Rose", artist: "Édith Piaf", durationSec: 198, videoId: "U2BTkr2GRUI" },
  ],
  zen: [
    ...
    { id: "z7", title: "Starboy (Lo-Fi Edit)", artist: "The Weeknd", durationSec: 210, videoId: "34_dRGSBBQ4" },
    { id: "z8", title: "Coffee", artist: "beabadoobee (Lo-Fi)", durationSec: 189, videoId: "YdBN38KPXNM" },
  ],
  energie: [
    ...
    { id: "e7", title: "Jump Around", artist: "House of Pain", durationSec: 215, videoId: "XhzCgHDOweo" },
  ...
  famille: [
    ...
    { id: "fa5", title: "We Are Family", artist: "Sister Sledge", durationSec: 217, videoId: "uyGmHYZuS2w" },
    ...
    { id: "fa8", title: "Best Day of My Life", artist: "American Authors", durationSec: 194, videoId: "Y66j_LGNQ7g" },
  ],
};

export function getTracksForMood(moodId: MoodId): Track[] {
  return TRACKS[moodId] ?? [];
}
